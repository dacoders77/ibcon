...
namespace IBApi
{
    ...
    public interface EWrapper
    {
         ...
         * @sa TickType, tickPrice, tickString, tickEFP, tickGeneric, tickOptionComputation, tickSnapshotEnd, marketDataTyp
         * @param field the type of size being received (i.e. bid size)e, EClientSocket::reqMktData
         */
        /**
